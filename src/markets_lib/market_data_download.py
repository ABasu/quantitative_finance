...
log_file = os.path.join(output_directory, av_api_function, args.log_file)
...
def get_path(ticker):
    ...
    """
    return os.path.join(output_directory,av_api_function,'{}.csv'.format(ticker))
...
while True:
    for n, ticker in enumerate(tickers):
        ...
        pause(ticker, n)
        ticker_df, nq = av.call_api(ticker, av_api_function, api_key, parameters=parameters)
